...
class AdminApiTest(BaseTestClass):
    ...
    def test_single_admin_get(self):
        ...
        json_res, dict_res = auth_get(self.client(), "admin/{}".format(auth_data['admin_id']), token=token)
        self.assertEqual(json_res.status_code, 200)
    ...
    def test_single_admin_update(self):
        ...
        u = "admin/{}".format(auth_data['admin_id'])
        json_res, dict_res = auth_put(self.client(), u, put_data, token)
        self.assertEqual(json_res.status_code, 200)
